...
# Composition: Departemen memiliki banyak karyawan
class Departemen:
    ...
    def tampilkan_karyawan(self):
        print(f"\nDaftar Karyawan Departemen {self.nama_departemen}:")
        for k in self.daftar_karyawan:
            print(k.info_gaji())


# -------------------------------------
# Instansiasi (2 Manager & 2 Programmer)
# -------------------------------------

m1 = Manager("musya", 5000000, 1500000)
m2 = Manager("nesa", 5500000, 2000000)

p1 = Programmer("tika", 4500000, 1000000)
p2 = Programmer("grace", 4700000, 1200000)
